  ...
  try {
    ...
    await runner.query(`
      ...
      VALUES
        ...
        (7, 'Fusion Secondary School (Lotus Gardens)', 'fusion-secondary-lotus', 'fusionsecondary.co.za', '700400812', 'Tshwane South District (D4)', 'Tshwane South', 'Gauteng', 'Lotus Gardens, Pretoria West, Gauteng, 0008', 'admin@fusionsecondary.co.za', '+27 12 373 0000', 'Dr. T. Makola', '#4f46e5', '#06b6d4', '#f59e0b', 'Innovate, Aspire, Achieve', 'CAPS (GDE Gauteng)', '8-12'),
        (8, 'Saulridge Secondary School', 'saulridge-secondary', 'saulridge.co.za', '700210712', 'Atteridgeville / Tshwane South (D4)', 'Tshwane South', 'Gauteng', 'Ramokgopa St, Saulsville, Atteridgeville, Pretoria, 0008', 'info@saulridge.co.za', '+27 12 375 6000', 'Mr. K. E. Masemola', '#1e3a8a', '#f59e0b', '#3b82f6', 'Knowledge is Power', 'CAPS (GDE Gauteng)', '8-12'),
        (9, 'Phelindaba Secondary School', 'phelindaba-secondary', 'phelindaba.co.za', '700210621', 'Atteridgeville / Tshwane South (D4)', 'Tshwane South', 'Gauteng', 'Kgwale St, Atteridgeville, Pretoria, 0008', 'admin@phelindaba.co.za', '+27 12 373 8100', 'Mrs. M. T. Sithole', '#14532d', '#eab308', '#10b981', 'Strive for Success', 'CAPS (GDE Gauteng)', '8-12'),
        (10, 'Flavius Mareka Secondary School', 'flavius-mareka', 'flaviusmareka.co.za', '700210340', 'Atteridgeville / Tshwane South (D4)', 'Tshwane South', 'Gauteng', 'Khoza St, Atteridgeville, Pretoria, 0008', 'principal@flaviusmareka.co.za', '+27 12 373 9200', 'Mr. L. N. Maluleke', '#1d4ed8', '#38bdf8', '#fbbf24', 'Excellence in Action', 'CAPS (GDE Gauteng)', '8-12'),
        (11, 'Dr. W.F. Nkomo Secondary School', 'wf-nkomo-secondary', 'wfnkomo.co.za', '700210217', 'Atteridgeville / Tshwane South (D4)', 'Tshwane South', 'Gauteng', 'Ramushu St, Atteridgeville, Pretoria, 0008', 'info@wfnkomo.co.za', '+27 12 375 7300', 'Mr. D. M. Ndlovu', '#881337', '#f43f5e', '#fbbf24', 'Labor Omnia Vincit (Work Conquers All)', 'CAPS (GDE Gauteng)', '8-12'),
        (12, 'Hofmeyr Secondary School', 'hofmeyr-secondary', 'hofmeyr.co.za', '700210456', 'Atteridgeville / Tshwane South (D4)', 'Tshwane South', 'Gauteng', 'Seeiso St, Atteridgeville, Pretoria, 0008', 'admin@hofmeyr.co.za', '+27 12 373 7400', 'Mrs. S. R. Mogale', '#581c87', '#14b8a6', '#f59e0b', 'Education for Liberation', 'CAPS (GDE Gauteng)', '8-12')
