  ...
  try {
    ...
    await runner.query(`
      ...
      VALUES
        ...
        (1, 'Geleza SA', 'fusion-high', 'geleza-sa.co.za', '911220001', 'Polokwane Central Circuit', 'Capricorn South', 'Limpopo', 'Polokwane Central, Limpopo, 0700', 'admin@geleza-sa.co.za', '+27 15 291 0000', 'Dr. T. Makola', '/assets/schools/geleza-sa.svg', '/assets/schools/geleza-sa.svg', '#0284c7', '#06b6d4', '#f59e0b', 'Geleza Smart, The Future Is Thine', 'CAPS (DBE Limpopo)', '8-12'),
      ...
      VALUES
        -- Science Stream (Grade 10-12) - Strictly Excludes CAT/IT, Includes Geography
        ...
        -- Grade 8-9 General CAPS Curriculum
      ...
      -- Safe idempotent constraint resolution for teacher_consultations
      DO $$
      BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'teacher_consultations_school_id_fkey') THEN
          BEGIN
            ALTER TABLE teacher_consultations ADD CONSTRAINT teacher_consultations_school_id_fkey FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE;
          EXCEPTION WHEN OTHERS THEN NULL;
          END;
        END IF;
      END $$;
