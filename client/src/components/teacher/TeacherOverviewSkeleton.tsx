...
export const TeacherOverviewSkeleton: React.FC = () => {
  return (
    <div className="space-y-6 sm:space-y-8 animate-fade-in pb-16 select-none" aria-busy="true" aria-label="Loading educator workspace">
      
      {/* 1. Educator Greeting & Status Banner Skeleton */}
      <div className="p-6 rounded-3xl bg-slate-100/90 dark:bg-surface-dark border border-slate-200/90 dark:border-white/10 shadow-sm relative overflow-hidden shimmer-wave">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-2">
            ...
            <div className="w-60 sm:w-88 h-7 rounded-xl bg-slate-300 dark:bg-white/15 animate-pulse" />
            <div className="w-44 sm:w-64 h-4 rounded-lg bg-slate-200 dark:bg-white/10 animate-pulse" />
          </div>
      ...
      {/* 2. Four Educator Metric Cards Skeleton */}
      ...
      <div className="space-y-4 rounded-3xl bg-slate-100 dark:bg-surface-darker border border-slate-300 dark:border-white/10 p-5 sm:p-6 shadow-sm relative overflow-hidden shimmer-wave">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
          {[1, 2, 3].map((s) => (
            ...
            >
              <div className="h-32 w-full bg-slate-200 dark:bg-white/10 p-3 flex flex-col justify-between">
                <div className="flex justify-between items-center">
                  <div className="w-16 h-5 rounded-full bg-slate-300 dark:bg-white/20 animate-pulse" />
                  <div className="w-14 h-5 rounded-full bg-slate-300 dark:bg-white/20 animate-pulse" />
                </div>
                <div className="space-y-1">
                  <div className="w-36 h-5 rounded-lg bg-slate-300 dark:bg-white/20 animate-pulse" />
                  <div className="w-24 h-3 rounded bg-slate-300 dark:bg-white/20 animate-pulse" />
                </div>
              </div>
