        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5">
          <div className="flex items-center gap-4">
            ...
            <div className="relative shrink-0">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl border border-cyan-400/30 bg-surface-darker shadow-sm overflow-hidden flex items-center justify-center text-white font-black text-lg md:text-xl">
                {profilePic ? (
                  <img
